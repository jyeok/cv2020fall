...
def Laplacian_Pyramid_Blending_with_mask(A, B, m, num_levels = 6):
    ...
    for i in range(num_levels-1,0,-1):
        ...
        cv2.imwrite(f'{i}th lp of A.png', LA)
        cv2.imwrite(f'{i}th lp of B.png', LB)
        lpA.append(LA)
        lpB.append(LB)
...
if __name__ == '__main__':
    A = cv2.imread("./images/player1_256x256.png",0)
    B = cv2.imread("./images/player2_256x256.png",0)
    # A = cv2.imread("./images/girl1.png",0)
    # B = cv2.imread("./images/girl2.png",0)
